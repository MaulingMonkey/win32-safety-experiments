unsafe extern "system" {
    ...
    /// Read the last set <code>[SetLastError]{,[Ex](https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-setlasterrorex)}\(dwErrorCode\)</code> on this thread.
    ///
    ...
    /// | DLL           | `kernel32.dll`
    ///
    pub safe fn GetLastError() -> ::winresult::ErrorHResultOrCode;
}
