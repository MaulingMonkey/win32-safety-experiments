unsafe extern "system" {
    ...
    /// -   `wLanguageId` &mdash;
    ///     Optional.
    ///     The `LANGID` to use for message box buttons.
    ///     Defaults to the default system language if none is specified.
    ///
    ///
    ///
    /// ## Returns
    ...
    safe fn MessageBoxExA(
        ...
        uType:          UINT,
        wLanguageId:    Option<::core::num::NonZeroU16>,
    ) -> c_int;
}
